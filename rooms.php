...
<title><?php echo $settings_select['site_title'] ?> - Phòng</title>
<link
  rel="stylesheet"
      ...
      <div class="container-fluid flex-lg-column align-items-stretch">
        ...
        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
          ...
          <div class="border bg-light p-3 rounded mb-3">
            ...
            <button id="chk_avail_btn" onclick="chk_avail_clear()" class="btn shadow-none btn-sm text-secondary d-none">Cài đặt lại</button>
          </h5>
          ...
          <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                <span>Thiết bị</span>
                <button id="facilities_btn" onclick="facilities_clear()" class="btn shadow-none btn-sm text-secondary d-none">Cài đặt lại</button>
            </h5>
            <?php 
          ...
          <div class="border bg-light p-3 rounded mb-3">
              <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                <span>Khách</span>
                <button id="guests_btn" onclick="guests_clear()" class="btn shadow-none btn-sm text-secondary d-none">Cài đặt lại</button>
            </h5>
            <div class="d-flex">
              <div class="me-2">
              <label class="form-label ">Ng lớn</label>
