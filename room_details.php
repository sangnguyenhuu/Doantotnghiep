...
<title><?php echo $settings_select['site_title'] ?> - Thông tin chi tiết phòng</title>
<link
  rel="stylesheet"
...
<body>
    ...
    <div class="col-lg-5 col-md-12 px-4">
      ...
      <div class="card-body">
          <?php
            ...
            echo<<<price
            <h4 style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Giá: $formatted_price VNĐ mỗi đêm </h4>
            price;
            ...
            // lấy cơ sở vật chất của phòng
              ...
              features;
                ...
                if(!$settings_select['shutdown'])
                {
                  ...
                  $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn w-100 text-white custom-bg shadow-none mb-2'>Đặt Phòng Ngay</button>";
                }
    ...
    <div class="col-12 mt-4 px-4">
         ...
         <div>
            <h5 class="mb-3">Nhận xét & đánh giá</h5>
            <?php
