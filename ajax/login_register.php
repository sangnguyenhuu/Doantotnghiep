<?php 
   ...
   function send_mail($uemail,$token,$type)
   {
        if($type == "email_confirmation")
        {
            ...
            $subject = "Link xác nhận tài khoản";
            $content = "Xác nhận tài khoản mail của bạn";
        }else{
            $page = 'index.php';
            $subject = "Link cài đặt lại mật khẩu";
            $content = "Cài đặt lại mật khẩu tài khoản của bạn";
        }
    ...
    if(isset($_POST['register']))
    {
        ...
        // kiểm tra mật khẩu và xác nhận mật khẩu có trùng k
       ...
       // gửi link xác nhận tới gmail người dùng
