<?php 
    ...
    if(isset($_POST['add_image']))
    {
        ...
        $img_r = uploadImage($_FILES['image'],ROOMS_FORDER);
    ...
    if(isset($_POST['get_room_images']))
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            <td>$thumb_btn</td>
            <td>
                <button onclick='remove_image($row[sr_no],$row[room_id])' class = 'btn btn-danger shadow-none'>
                <i class ='bi bi-trash'></i>
                </button>
            </td>
            </tr>
    ...
    if(isset($_POST['remove_image'])) 
    {
        ...
        if(deleteImage($img['image'], ROOMS_FORDER)) {
    ...
    if(isset($_POST['remove_room'])) 
    {
        ...
        {
            deleteImage($row['image'],ROOMS_FORDER);
        }
