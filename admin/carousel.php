    ...
    <div class="container-fluild" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
               <h3 class="mb-4">Ảnh trang trượt trang web</h3>

                <!-- Phần Carouse-->
             <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class = "class-title m-0">Ảnh</h5>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="carousel_picture.value=''" class="btn text-secondary" data-bs-dismiss="modal">Hủy bỏ</button>
